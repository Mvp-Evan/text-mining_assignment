...
class Config(object):
    ...
    def get_train_batch(self):
        ...
        sent_idxs = torch.LongTensor(self.batch_size, self.sent_limit, self.word_size).to(self.device)
        reverse_sent_idxs = torch.LongTensor(self.batch_size, self.max_length).to(self.device)
